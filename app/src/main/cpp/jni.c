...
JNIEXPORT jlong JNICALL
Java_com_example_aiexpensetracker_WhisperLib_initContextFromAsset(
        JNIEnv* env,
        jclass clazz,
        jobject assetManager,
        jstring modelPath) {

    return 0; // dummy context for now
}

// fullTranscribe
JNIEXPORT void JNICALL
Java_com_example_aiexpensetracker_WhisperLib_fullTranscribe(
        JNIEnv* env,
        jclass clazz,
        jlong ctx,
        jint nSamples,
